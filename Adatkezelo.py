...
from Szalloda.SzallodaInterface import SzallodaInterfesz
...
class Adatkezelo():
    ...
    def kezdo_adatok_feltoltese(self):
        szalloda1 = Szalloda("Wizzarding World Hotel", 5, True)
        szalloda2 = Szalloda("Middle-Earth Inn", 4, True)
        ...
        szalloda1.szoba_hozzaadasa(KetagyasSzoba(15000, 103, 60, "Incendio", "Wizzard Delux", "Észak-Kelet"))
        szalloda1.szoba_hozzaadasa(KetagyasSzoba(17000, 104, 70, "Imperio", "Wizzard Apartman", "Észak-Nyugat"))
        ...
        szalloda2.szoba_hozzaadasa(KetagyasSzoba(15000, 203, 60, "Khazad-Dûm", "Middle-Earth Delux", "Észak-Kelet"))
        szalloda2.szoba_hozzaadasa(KetagyasSzoba(18000, 204, 70, "Eregion", "Middle-Earth Apartman", "Észak-Nyugat"))
    ...
    def futtat(self):
        while True:
            ...
            for i, szalloda in enumerate(self.szallodak, start=1):
                print(f"{i}. {szalloda.szalloda_neve}")
            ...
            akt_szalloda_interfesz = SzallodaInterfesz(akt_szalloda)
            akt_szalloda_interfesz.futtat()
